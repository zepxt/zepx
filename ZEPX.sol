...
contract ZEPXToken is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'ZEPX Token';
    string  private _SYMBOL = 'ZEPX';
    ...
    uint256 private _MAX_TX_SIZE = 100000000000000000 * _DECIMALFACTOR;
